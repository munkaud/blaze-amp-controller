    ...
    if (zoneMatch) {
      ...
      // Zone Dynamics Signal
        ...
        if (signalMatch) {
          ...
          instance.state.zoneDynamics[zid].signal = parseFloat(signalMatch[1]);
          instance.log('debug', `Zone ${zoneLetter} dynamics signal set to ${instance.state.zoneDynamics[zid].signal} dB`);
          stateChanged = true;
        }
      }
    }
